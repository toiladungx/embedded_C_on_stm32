...
#ifndef DRIVERS_INC_STM32F103C8T6_H_
#define DRIVERS_INC_STM32F103C8T6_H_
...
#define FLASH_BASEADDR					0x08000000U		//p45(main memory)
#define SRAM1_BASEADDR					0x20000000U		//p42
#define ROM_BASEADDR					0x1FFFF000U		//p45(system memory)
...
typedef struct
{
  ...
  __vo uint32_t AHBSTR;        			//Address offset: 0x28
...
#define SPI3_REG_RESET()   				do{(RCC->APB1ENR |= (1 << 15));	(RCC->APB1ENR &= ~(1 << 4));}while(0)
...
//IRQ (Interrupt Request) Numbers of STM32F103xx MCU
...
#include "../Drivers/Inc/stm32f103c8t6_i2c_driver.h"


#endif /* DRIVERS_INC_STM32F103C8T6_H_ */
